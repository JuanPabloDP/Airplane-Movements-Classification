...
IP_ADDRESS = '192.168.1.72'         # Replace with your device's IP address
COMMAND = 'accX&accY&accZ&acc_time&lin_accX&lin_accY&lin_accZ'     # Command to fetch acceleration data
...
try:
    while True:
        ...
        if data and data['time']:
            print(f"t = {data['time']:.3f}s | accX = {data['accX']:.4f}, accY = {data['accY']:.4f}, accZ = {data['accZ']:.4f}, lin_accX = {data['lin_accX']:.4f}, lin_accY = {data['lin_accY']:.4f}, lin_accZ = {data['lin_accZ']:.4f}")        
